	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'mummy':
				...
				animation.addByPrefix('singUP', 'Izotope Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Izotope Right', 24, false);
				animation.addByPrefix('singDOWN', 'Izotope Down', 24, false);
				animation.addByPrefix('singLEFT', 'Izotope Left', 24, false);
